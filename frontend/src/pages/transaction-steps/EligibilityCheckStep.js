  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        >
          Back to Sanction Check
        </button>
      </div>
      
      <TransactionStepIndicator transactionId={id} currentStep="eligibility-check" />
      
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Eligibility Check</h2>
        <p className="text-gray-600 mb-8">This is a placeholder for the Eligibility Check step implementation.</p>
