  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        >
          Back to Limits Check
        </button>
      </div>
      
      <TransactionStepIndicator transactionId={id} currentStep="pricing" />
      
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Pricing</h2>
        <p className="text-gray-600 mb-8">This is a placeholder for the Pricing step implementation.</p>
        ...
        <div className="mt-6 flex justify-end">
          ...
          >
            Continue to Earmarking of Limits
          </button>
        </div>
      </div>
    </div>
